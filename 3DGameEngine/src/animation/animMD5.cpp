...
bool animMD5::LoadAnimation( const std::string& filename )
{
...
void animMD5::BuildFrameSkeleton( FrameSkeletonList& skeletons, const JointInfoList& jointInfos, const BaseFrameList& baseFrames, const FrameData& frameData )
{
...
void animMD5::Update( float fDeltaTime )
{
...
void animMD5::InterpolateSkeletons( FrameSkeleton& finalSkeleton, const FrameSkeleton& skeleton0, const FrameSkeleton& skeleton1, float fInterpolate )
{
    for ( int i = 0; i < _iNumJoints; ++i )
    {
